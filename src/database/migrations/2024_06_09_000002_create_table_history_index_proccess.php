...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('history_index_proccess', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('history_index_proccess', function (Blueprint $table) {
            $table->dropConstrainedForeignId('id_client');
            $table->dropConstrainedForeignId('id_index');
        });
        Schema::dropIfExists('history_index_proccess');
    }
};